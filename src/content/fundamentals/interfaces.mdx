...
<Playground client:visible title="polymorphism.go" code={`package main
...
<Playground client:visible title="method-sets.go" code={`package main
...
<Playground client:visible title="any.go" code={`package main
...
<Playground client:visible title="sort-interface.go" code={`package main
