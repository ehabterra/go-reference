...
status: ready
intent: "Composition over inheritance — promoted fields and methods, embedding structs and interfaces, pointer vs value embedding, shadowing and overriding, ambiguity, and the classic mutex / io-wrapper patterns."
related:
  - structs
  - interfaces
  - methods
