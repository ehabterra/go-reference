...
difficulty: "Beginner"
status: ready
intent: "Strings are immutable UTF-8 bytes — why len counts bytes not characters, why indexing gives a byte, how runes and []byte and []rune conversions copy, strings.Builder, the text packages, and where runes stop (grapheme clusters)."
related:
  - slices
  - variables-and-types
  - control-flow
