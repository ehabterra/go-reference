...
difficulty: "Advanced"
status: ready
intent: "Inspecting and modifying types and values at runtime with reflect — TypeOf / ValueOf, Type vs Kind, iterating struct fields and reading tags, the three laws of reflection, Interface() to box back to any, the pointer/Elem settability rule, and why reflection is powerful but slow."
related:
  - interfaces
  - type-assertions
  - structs
