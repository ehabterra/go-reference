...
difficulty: "Beginner"
status: ready
intent: "Branching and looping the Go way — if with an init statement and tight scope; the single for loop in all four forms plus range over slices, maps, strings, channels and integers; switch (expression, tagless, type, fallthrough, multi-value); labeled break/continue for nested loops; and defer in depth (LIFO order, argument evaluation timing, the loop pitfall)."
related:
  - variables-and-types
  - functions
  - slices
