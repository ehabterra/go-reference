...
difficulty: "Beginner"
status: ready
intent: "How Go code is organized — the package clause, Capitalized exports as encapsulation, the import forms (alias, blank, dot), init() ordering and package-variable init, doc comments; then modules: go.mod / go.sum, go get / mod tidy, semantic versioning and the v2+ rule, minimal version selection, internal/ packages, and replace / workspaces."
related:
  - variables-and-types
  - interfaces
  - reflection
