...
difficulty: "Beginner"
status: ready
intent: "Go's built-in hash table — make and literals, set/get, the comma-ok presence test, delete, len, randomized ranging, sets and maps of slices, allowed key types, the nil-map write panic, concurrency safety, and the maps package."
related:
  - slices
  - structs
  - hash-tables
