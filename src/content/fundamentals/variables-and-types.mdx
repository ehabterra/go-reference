...
status: ready
intent: "How Go names and types values — var, :=, and const; typed vs untyped constants and why untyped constants adapt; iota and bit-flag enums; the numeric types with explicit conversion and overflow rules; byte/rune aliases; guaranteed zero values; scope, shadowing, multiple assignment, and the blank identifier."
related:
  - control-flow
  - functions
  - pointers
