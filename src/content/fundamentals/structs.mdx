...
difficulty: "Beginner"
status: ready
intent: "Grouping related fields into one named type — literals, the zero value, nesting, anonymous structs, embedding, struct tags, value-copy semantics, comparability with ==, the empty struct, and a note on field layout."
related:
  - pointers
  - methods
  - slices
