...
status: ready
intent: "Errors are ordinary values you return last and check — the error interface, sentinels, wrapping with %w to build a chain, matching through it with errors.Is / As / Join, custom error types with Unwrap, and when to wrap vs annotate vs handle vs return as-is."
related:
  - functions
  - panic-recover
  - type-assertions
