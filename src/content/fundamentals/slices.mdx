...
difficulty: "Beginner"
status: ready
intent: "Go's go-to list type — the (ptr,len,cap) header, make, append and amortized growth, the s[a:b] window and the full three-index slice, the aliasing trap, copy, nil vs empty, ranging, 2-D slices, insert/delete idioms, and the slices package."
related:
  - structs
  - maps
  - arrays-and-slices
