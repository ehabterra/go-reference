  ...
  - q: "Which single principle underlies nearly every design pattern?"
    options:
      ...
      - text: "Avoid interfaces"
        correct: false
    explain: "Almost every pattern isolates the volatile part of a design behind a stable boundary: Strategy isolates an algorithm, Decorator isolated added behavior, Factory isolates construction. 'Encapsulate what varies' is the seed most patterns grow from."
