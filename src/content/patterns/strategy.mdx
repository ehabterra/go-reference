...
aka: "Policy"
source: "https://github.com/ehabterra/golearn/blob/main/patterns/gof/strategy/main.go"
when_use:
...
The [full example in the repo](https://github.com/ehabterra/golearn/blob/main/patterns/gof/strategy/main.go) extends this with a `QuackBehavior` too, plus concrete `MallardDuck` and `RubberDuck` types that embed a base `Duck` — a great look at composition.
