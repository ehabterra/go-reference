...
aka: "Wrapper"
source: "https://github.com/ehabterra/golearn/blob/main/patterns/gof/decorator/main.go"
when_use:
...
The repo uses an explicit `component Beverage` field. Go's **struct embedding** makes it even tighter — embed the interface and override only `Description` and `Cost`. Edit and **Run**:
