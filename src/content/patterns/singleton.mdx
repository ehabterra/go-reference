...
aka: "Single instance"
source: "https://github.com/ehabterra/golearn/blob/main/patterns/gof/singleton/main.go"
when_use:
...
A country has exactly one official government. No matter who you ask or where you are, "the government" refers to the same single entity — and there's a well-known way to reach it. You can't accidentally spin up a second one.
</Callout>
...
The [example in the repo](https://github.com/ehabterra/golearn/blob/main/patterns/gof/singleton/main.go) passes the `*sync.Once` in as a parameter and even recovers from panics during construction — a nice way to see the mechanics laid bare. In production you'd usually keep the `sync.Once` as an unexported package-level variable instead.
