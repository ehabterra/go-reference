...
aka: "Object tree"
source: "https://github.com/ehabterra/golearn/blob/main/patterns/gof/composite/main.go"
when_use:
...
quiz:
  ...
  - q: "Which pattern most naturally pairs with Composite to walk the tree?"
    options:
      ...
      - text: "Adapter"
        correct: false
    explain: "Iterator gives clients a uniform way to traverse the composite without exposing its tree structure — exactly what the repo example does with a depth-first compositeIterator."
---
