...
source: "https://github.com/ehabterra/golearn/blob/main/patterns/gof/facade/main.go"
when_use:
...
The facade is a struct holding its subsystems as **small interfaces** — which keeps it decoupled and trivially testable with fakes. This mirrors the repo's `Order` type. Edit and **Run**:
